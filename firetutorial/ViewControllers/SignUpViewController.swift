...
class SignUpViewController: UIViewController {
    ...
    // Check the fields and validate that data is correct. If everything is correct this returns nil otherwise it returns error message
...
//            Should use "self." when referencing within closure
        }
